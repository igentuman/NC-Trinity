...
public class EntityNuclearCloud extends Entity implements INuclearEffect {
	...
	private static final DataParameter<Integer> AGE = EntityDataManager.createKey(EntityNuclearCloud.class, DataSerializers.VARINT);
	
	private static final DataParameter<Integer> MAXAGE = EntityDataManager.createKey(EntityNuclearCloud.class, DataSerializers.VARINT);
	
	public static final DataParameter<Float> SCALE = EntityDataManager.createKey(EntityNuclearCloud.class, DataSerializers.FLOAT);
	
	public static final DataParameter<Byte> SOMETHING = EntityDataManager.createKey(EntityNuclearCloud.class, DataSerializers.BYTE);
	...
	public static EntityNuclearCloud statFacBale(World world, double x, double y, double z, float radius, int maxAge) {
