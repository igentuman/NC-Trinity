...
public class ResourceManager {
	...
	public static final ResourceLocation objTesterModelRL = new ResourceLocation(Reference.MOD_ID, "models/mush.hmf");
	public static final ResourceLocation ringModelRL = new ResourceLocation(Reference.MOD_ID, "models/Ring.obj");
	public static final ResourceLocation ringBigModelRL = new ResourceLocation(Reference.MOD_ID, "models/RingBig.obj");
	public static final ResourceLocation sphere = new ResourceLocation(Reference.MOD_ID, "models/sphere.obj");
	// Blast
